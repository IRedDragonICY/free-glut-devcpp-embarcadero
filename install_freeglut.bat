...
echo.
xcopy /E /Y "%cd%\include\GL" "%manual_path%\TDM-GCC-64\x86_64-w64-mingw32\include\GL\"
echo  Copied include files...
xcopy /Y "%cd%\lib\x64\*.a" "%manual_path%\TDM-GCC-64\x86_64-w64-mingw32\lib\"
echo  Copied x64 lib files...
xcopy /Y "%cd%\lib\*.a" "%manual_path%\TDM-GCC-64\x86_64-w64-mingw32\lib32\"
